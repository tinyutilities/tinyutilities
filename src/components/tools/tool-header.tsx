...
// No "Back to tools" link here — the `Breadcrumbs` rendered above this in
// src/app/tools/[slug]/page.tsx already provides that (and more: Home / Tools / Category).
export function ToolHeader({ tool, statusLabel = "Coming Soon" }: ToolHeaderProps) {
  return (
    <section className="overflow-hidden rounded-3xl border border-white/10 bg-white/[0.04] p-8 shadow-2xl shadow-black/20 sm:p-10">
